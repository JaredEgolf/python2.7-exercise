...
def gather_info():
    ...
    weight = float(raw_input("What is your weight? (pounds or kilos) "))
    unit = raw_input("Are your measurements in metric or imperial? ").lower().strip()
...
while True:
    ...
    if unit.startswith('i'):
        ...
        print("Error: Unknown measurement unit.  Please use imperial or metric. ")
